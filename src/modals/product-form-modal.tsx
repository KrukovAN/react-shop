...
const validateValues = (
  ...
  if (description.length > DESCRIPTION_MAX_LENGTH) {
    errors.description =
      `Описание не должно быть длиннее ${DESCRIPTION_MAX_LENGTH} символов.`;
  }
  ...
  if (!categoryName) {
    ...
    errors.categoryName =
      `Категория не должна быть длиннее ${CATEGORY_MAX_LENGTH} символов.`;
  }
